-- Step 13: point-in-time vintage read path
-- Applied to Supabase production via migration:
-- add_point_in_time_vintage_query

create or replace function public.get_indicator_vintage_as_of(
  p_indicator text,
